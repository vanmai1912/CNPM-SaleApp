...
class User(BaseModel, UserMixin):
    ...
    active = Column(Boolean, default=True)
    user_role = Column(Enum(UserRoll), default=UserRoll.USER)
...
if __name__ == '__main__':
    with app.app_context():
        ...
        import hashlib
        password = str(hashlib.md5('123455'.encode('utf-8')).digest())
        u = User(name='Mãi', username='admin', password=password,
                 user_role = UserRoll.ADMIN,
